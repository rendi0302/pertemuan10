                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <button class="btn btn-primary float-right" data-toggle="modal" data-target="#tambahBukuModal"
                            importbuku><i class="fa fa-plus"></i> Tambah Data</button>
                        ...
                        <button type="button" class="btn btn-warning" data-toggle="modal"
                            data-target="#importBuku">Import</button>
                        <hr />
                    </div>
                    <div class="card-body">
                                        ...
                                        <td>
                                            <div class="btn-group" role="group" aria-label="Basic example">
                                                <button type="button" id="btn-edit-buku" class="btn btn-success"
                                                    ...
                                                    data-id="{{ $book->id }}">Ubah</button>
                                                <button type="button" id="btn-delete-buku" class="btn btn-danger"
                                                    data-toggle="modal" data-target="#deleteBukuModal"
                                                    data-id="{{ $book->id }}"
                                                    data-cover="{{ $book->cover }}">Hapus</button>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
                ...
                <div class="modal-body">
                    <form method="post" action="{{ route('admin.book.submit') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input min="1" type="number" id="datepicker" class="form-control" name="tahun" id="tahun"
                                required />
                        </div>
                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input min="1" type="number" id="datepicker" class="form-control" name="tahun"
